                ...
                <section class="register-section-card">
                    ...
                    <div class="register-grid register-grid-owner">
                        ...
                        <label class="register-field" for="owner_whatsapp">
                            ...
                            <input id="owner_whatsapp" name="owner_whatsapp" type="text" class="register-input" value="{{ old('owner_whatsapp') }}" placeholder="0812xxxx" required>
                            <span class="register-note">
                                <img src="{{ asset('images/register/info-note.svg') }}" alt="" aria-hidden="true">
                                Digunakan untuk notifikasi transaksi &amp; pemulihan akun.
                            </span>
                        ...
                        <label class="register-field" for="owner_email">
                            ...
                            <input id="owner_email" name="owner_email" type="email" class="register-input" value="{{ old('owner_email') }}" placeholder="nama@email.com" required>
                            @error('owner_email')
                            <p class="field-error">{{ $message }}</p>
                            @enderror
                        </label>
